          ...
          <Col>
            ...
            <SlideInSection direction="left">
              <Row className='d-flex justify-content-center align-items-center mb-5'>
                <Col className='d-flex justify-content-center align-items-center flex-column'>
                  <h1 className="d-md-none d-sm-block">TARA</h1>
                  <img className='projectImgHorizontal' src={tara} alt="TARA Project"></img>
                </Col>
                ...
                <Col>
                  ...
                  <div className='techsUsed d-flex flex-wrap '>
            ...
            <SlideInSection direction="right">
              <Row className='d-flex justify-content-center align-items-center mb-5'>
                ...
                <Col className='d-flex justify-content-center align-items-center flex-column order-1 order-md-2'>
                  <h1 className="d-md-none d-sm-block">QuizPlus</h1>
